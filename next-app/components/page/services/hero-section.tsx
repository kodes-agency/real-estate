...
export const HeroSection = ({ page }: { page: ServicesPage }) => {
  return (
    <section className="relative min-h-[800px] lg:min-h-[90vh] flex flex-col justify-center lg:justify-end bg-black rounded-b-2xl overflow-hidden shadow-2xl/30">
      ...
      <div className="z-20 flex flex-col items-center justify-center lg:pb-[5vh]">
        <GoldSvg
      ...
      <div className="inset-0 z-20 p-5 md:p-10 lg:p-14">
        <div className=" space-y-4 lg:space-y-0 flex lg:flex-row h-fit flex-col justify-center lg:justify-between items-center lg:items-end text-white">
          ...
          <p className="max-w-sm lg:max-w-lg lg:text-end text-lg pb-2 text-center whitespace-pre-line">
            {page.hero.subtitle}
          </p>
        </div>
