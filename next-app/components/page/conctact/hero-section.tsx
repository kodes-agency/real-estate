...
export const HeroSection = ({ page }: { page: ContactPage }) => {
  return (
    <section className="relative min-h-[650px] lg:min-h-[90vh] flex flex-col justify-center lg:justify-end bg-black rounded-b-2xl overflow-hidden shadow-2xl/30">
